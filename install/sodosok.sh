#!/bin/bash
#shadowsocks-libev obfs install By why
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/myridwan/prem/ipuk/ss/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/myridwan/prem/ipuk/ss/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/myridwan/prem/ipuk/ss/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/myridwan/prem/ipuk/ss/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
