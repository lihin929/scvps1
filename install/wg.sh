...
echo -e "${Info} Wireguard VPS AutoScript by Drg"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/myridwan/prem/ipuk/wireguard/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/myridwan/prem/ipuk/wireguard/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/myridwan/prem/ipuk/wireguard/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/myridwan/prem/ipuk/wireguard/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
